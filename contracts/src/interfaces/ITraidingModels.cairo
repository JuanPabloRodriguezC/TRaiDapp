...
pub trait ITraidingModelsMetrics<TContractState> {
    ...
    fn get_portfolio_value(self: @TContractState, asset_id: felt252, amount: u128) -> u128;
    fn get_bot_portfolio_value(self: @TContractState, asset_id: felt252, model_id: u64) -> u128;
    fn get_model_error(self: @TContractState, model_id: u64, asset_id: felt252) -> (u128, u128);
    fn get_model_roi(self: @TContractState, model_id: u64, asset_id: felt252) -> (u128, bool);
    fn get_model_sharpe_ratio(self: @TContractState, model_id: u64, asset_id: felt252) -> felt252;
    fn get_model_max_drawdown(self: @TContractState, model_id: u64, asset_id: felt252) -> u128;
    fn get_model_winning_ratio(self: @TContractState, model_id: u64, asset_id: felt252) -> u8;
}
