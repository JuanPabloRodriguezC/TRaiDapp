...
pub trait ITraidingModelsMetrics<TContractState> {
    ...
    fn update_model_predictions(ref self: TContractState, model_id: u64, asset_id: felt252, prediction: felt252) -> bool;
    fn get_model_error(ref self: TContractState, model_id: u64, asset_id: felt252) -> felt252;
    fn get_model_roi(ref self: TContractState, model_id: u64, asset_id: felt252) -> felt252;
...
pub trait ITraidingModelsOrders<TContractState> {
    ...
    fn calculate_model_fees(ref self: TContractState, model_id: u64, asset_id: felt252) -> u128;
}