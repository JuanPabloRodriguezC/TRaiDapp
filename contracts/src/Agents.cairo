...
mod AgentManager {
    ...
    use crate::utils::types::{
        AgentConfig, UserConfig, UserSubscription, TradeDecision, AgentPerformance, UserBalance
    };
    use crate::interfaces::IAgents::IAgent;
    ...
    struct Storage {
        ...
        // Trading decisions made by agents
    ...
    struct BalanceUpdated {
        ...
        new_total_balance: u256,
        new_available_balance: u256,
    }
    ...
    impl AgentImpl of IAgent<ContractState> {
        ...
        fn deposit_for_trading(
            ...
            let new_total_balance = balance.total_balance + amount;
            let new_available_balance = balance.available_balance + amount;
            balance.total_balance = new_total_balance;
            balance.available_balance = new_available_balance;
